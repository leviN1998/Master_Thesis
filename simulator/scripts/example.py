...
# Use absolute path because its a copy without the example files
path_Cube = "/home/lkolmar/dev/IEBCS/data/"
...
texture.image = bpy.data.images.load(path_Cube + "../examples/01_Blender" + "/CheeseTextureImg.png")
...
ppsee.init_tension()
ppsee.init_bgn_hist(path_Cube + "noise_pos_161lux.npy", path_Cube + "noise_pos_161lux.npy")
