...
ball.rotation_axis_angle = (0, 1, 1, -1)
ball.keyframe_insert(data_path="rotation_axis_angle", frame=0, index=-1)

ball.rotation_axis_angle = (np.pi*3, 1, 1, -1)
...
ppsee.set_sensor_optics(cam_focal)
...
if render:
    ...
    video = cv2.VideoWriter(path_output + output_name + ".avi", fourcc, 20.0, (ppsee.def_x, ppsee.def_y))
