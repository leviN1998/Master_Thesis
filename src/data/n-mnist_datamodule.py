...
class N_MNISTDataModule(LightningDataModule):
    ...
    def num_classes(self) -> int:
        ...
        :return: The number of N-MNIST classes (10).
        """
        return 10
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if not self.data_train and not self.data_val and not self.data_test:
            trainset = tonic.datasets.NMNIST(self.hparams.data_dir, train=True, transform=self.transforms)
            testset = tonic.datasets.NMNIST(self.hparams.data_dir, train=False, transform=self.transforms)
