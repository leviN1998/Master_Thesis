...
if __name__ == "__main__":
    ...
    for i in range(n):
        ...
        initial_orientation.set_axis(0, 180, 0)
        spin = rotations.Rotation()
        spin.set_axis(30, 0, 0)
        start_pos = [data["ball_start_x"], data["ball_start_y"], data["ball_start_z"]]
        end_pos = [data["ball_end_x"], data["ball_end_y"], data["ball_end_z"]]
        config["ball_start"] = start_pos
        config["ball_end"] = end_pos
